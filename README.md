...
```javascript
import ndarray2fancy from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-to-fancy@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory, idx } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-to-fancy@v0.1.1-deno/mod.js';
```
...
[@stdlib/array/to-fancy]: https://github.com/stdlib-js/array-to-fancy/tree/deno
